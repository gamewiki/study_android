...
//            483532, 504758 };
    ...
    private static void Lunar1(Date objDate) {
        ...
        //获取农历的时间基数农历1900年正月初一的时间
        Date baseDate = cl.getTime();
        //1900-01-31是农历1900年正月初一（获取距其的天数）
...
//        log.debug("SY=" + SY + "SM=" + SM + "SD=" + SD + "sy=" + sy);
    ...
    public static PersonDestiny getPersonBySolar(int y, int m, int d,PersonDestiny person) {
    	String year = y+"";
    	String month = m+"";
    	String day = d+"";
        Date sDObj;
        ...
        //日期
        Lunar1(sDObj); //农历
        person.setYear(getYear());
        person.setMonth(getMonth());
        person.setDay(getDay());
        person.setUsereight(cyclical(getYearCyl()) + cyclical(getMonCyl()) + cyclical(getDayCyl()));
        return person;
    }
    public static void main(String[] args) {
        ...
        System.out.println(getLunar("2050", "7", "18"));
