...
public class AboutActivity extends Activity  implements  OnGestureListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		shareNote = this.getString(R.string.shareNote1)+this.getString(R.string.shareNote2);
...
//            intent.setType("image/*");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, AppConstant.EXIT, 1, R.string.exit).setIcon(R.drawable.exit);
