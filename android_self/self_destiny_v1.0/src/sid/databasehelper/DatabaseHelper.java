...
//			第一个key存放列名，第二个参数插入值
		...
		//初始化地支数据
		for (Earth earth : AppConstant.earths) {
			ContentValues value = new ContentValues();
		...
		//初始化年重数据
		for (YearWeight year : AppConstant.years) {
			ContentValues value = new ContentValues();
		...
		//初始化月重数据
		for (MonthWeight month : AppConstant.months) {
			ContentValues value = new ContentValues();
		...
		//初始化日重数据
		for (DayWeight day : AppConstant.days) {
			ContentValues value = new ContentValues();
		...
		//初始化时重数据
		for (HourWeight hour : AppConstant.hours) {
			ContentValues value = new ContentValues();
		...
		//初始化男命数据
		for (PersonDestiny man : AppConstant.men) {
			ContentValues value = new ContentValues();
		...
		//初始化女命数据
		for (PersonDestiny woman : AppConstant.women) {
			ContentValues value = new ContentValues();
