...
public class CalendarView extends View implements View.OnTouchListener {
	...
	private Integer periodDays = null;
	...
	private void init() {
		...
		this.getBackground().setAlpha(204);
...
//		}
	...
	private void initDays(Canvas canvas) {
		// 计算日期
		calculateDate();
		// 按下状态，选择状态背景色
...
//		}
		if (null!=periodDay) {
//			System.out.println(" start num is :"+curStartIndex+"  today is :"+(periodDay+curStartIndex-1));
			int perviousD = periodDay - 19 + curStartIndex-1;
			int perviousS = periodDay - 9 + curStartIndex-1;
			int perviousC = periodDay - 3 + curStartIndex-1;
			int perviousP = periodDay + curStartIndex-1;
			int pervious = periodDay + 5 + curStartIndex-1;
			...
			for (int i = 0; i < 42; i++) {
				...
				if (isLastMonth(i)) {
					...
					color = surface.blueColor;
				} else if (i<pervious) {
					color = surface.yellowColor;
				} else if (i<nextD) {
					color = surface.greenColor;
				} else if (i<nextS) {
					color = surface.todayNumberColor;
	...
	private void initWeeks(Canvas canvas) {
		// 画框
...
//				}
	...
	private class Surface {
		...
		public int blueColor = Color.rgb(117, 210, 240);
		public int greenColor = Color.GREEN;
		public int yellowColor = Color.YELLOW;
