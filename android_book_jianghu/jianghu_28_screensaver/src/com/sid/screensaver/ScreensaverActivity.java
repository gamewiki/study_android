...
public class ScreensaverActivity extends Activity {
	...
	private static int[] screenDrawable = new int[] { R.drawable.screen1,
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case (MENU_ABOUT):
			new AlertDialog.Builder(ScreensaverActivity.this)
					.setTitle(R.string.app_about)
					.setIcon(R.drawable.hippo)
	...
	public void onUserWakeUpEvent() {
		if (bIfRunScreenSaver == true) {
			try {
				...
				mInflater01 = LayoutInflater.from(ScreensaverActivity.this);
