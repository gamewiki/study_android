	...
	public void onCreate(Bundle savedInstanceState) {
				...
				new TimePickerDialog(ClockActivity.this,
						new TimePickerDialog.OnTimeSetListener() {
							public void onTimeSet(TimePicker view,
								...
								Intent intent = new Intent(ClockActivity.this,ClockToRinging.class);
								/* 创建PendingIntent */
								PendingIntent sender = PendingIntent
										.getBroadcast(ClockActivity.this, 0,
												intent, 0);
								/*
		...
		mButton2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Toast.makeText(ClockActivity.this, "闹钟时间解除", Toast.LENGTH_SHORT)
						.show();
		...
		final AlertDialog di = new AlertDialog.Builder(ClockActivity.this)
				...
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						setTime2.setText("设置闹钟时间为" + tmpS + "开始，重复间隔为" + times
								/ 1000 + "秒");
						/* 以Toast提示设置已完成 */
						Toast.makeText(
								ClockActivity.this,
								"设置闹钟时间为" + tmpS + "开始，重复间隔为" + times / 1000
